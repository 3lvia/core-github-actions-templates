...
We use the internal tool [gh-action-docs](internal/gh-actions-docs) to auto-generate the documentation for the actions.
...
See the [gh-actions-docs README](internal/gh-actions-docs/README.md) for more information.
