...
We use [github-markdown-toc](https://github.com/ekalinin/github-markdown-toc) to generate the table of contents in the README.
This process shouldn't need manual intervention, and it should automatically add your new action to the table of contents.
