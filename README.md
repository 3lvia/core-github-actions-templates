...
| `GC_PROJECT_ID`          | Project ID of the Google Cloud project to push to. Only required if using GCR.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | no       |                |
...
- name: Build
  ...
  with:
    ...
    GC_PROJECT_ID:
    # Project ID of the Google Cloud project to push to. Only required if using GCR.
    #
    # Required: no
