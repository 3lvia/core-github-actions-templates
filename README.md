...
| `test-results-artifact-name`  | Name of the workflow artifact that the raw .trx test result files are uploaded to. Must be unique within the workflow run.                                                | no       | `unit-test-results-${{ github.job }}` |
...
| `test-results-artifact-name`  | Name of the workflow artifact that the raw .trx test result files are uploaded to. Must be unique within the workflow run.                                                | no       | `integration-test-results-${{ github.job }}` |
| `test-results-retention-days` | How many days to keep the uploaded test result artifact.                                                                                                                  | no       | `14`                                         |
...
| `test-results-artifact-name`  | Name of the workflow artifact that the raw .trx test result files are uploaded to. Must be unique within the workflow run.           | no       | `smoketest-results-${{ github.job }}` |
| `test-results-retention-days` | How many days to keep the uploaded test result artifact.                                                                             | no       | `14`                                  |
