...
| `csproj-file`                                                          | :warning: **DEPRECATED**: _This input is deprecated and has been superseded; please use `project-file` instead. `csproj-file` will be removed in the future._ :warning:                                                                                                                                                                                        |
| Path to a csproj-file, e.g. `src/my-app/my-app.csproj`.                | no                                                                                                                                                                                                                                                                                                                                                             |          |
| `disable-trivy`                                                        | :warning: **DEPRECATED**: _This input is deprecated and will be removed in the future._ :warning:                                                                                                                                                                                                                                                              |
| If `true`, the action will not run Trivy. **THIS IS NOT RECOMMENDED.** | no                                                                                                                                                                                                                                                                                                                                                             | `false`  |
...
| `dockerfile`                                                           | :warning: **DEPRECATED**: _This input is deprecated and has been superseded; please use `project-file` instead. `dockerfile` will be removed in the future._ :warning:                                                                                                                                                                                         |
| Path to a Dockerfile, e.g. `src/Dockerfile`.                           | no                                                                                                                                                                                                                                                                                                                                                             |          |
