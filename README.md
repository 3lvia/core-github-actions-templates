...
| `disable-trivy-report`        | If `true`, the action will not upload Trivy scan results to GitHub Security tab.                                                                                                                                                                                                                                                                               | no       | `false`                                |
...
- name: Build
  ...
  with:
    ...
    disable-trivy-report:
    # If `true`, the action will not upload Trivy scan results to GitHub Security tab.
    #
    # Required: no
    # Default: 'false'
