...
| `csproj-file`                 | :warning: **DEPRECATED**: _This input is deprecated and has been superseded; please use `project-file` instead. `csproj-file` will be removed in the future._ :warning:<br><br>Path to a csproj-file, e.g. `src/my-app/my-app.csproj`.                                                                                                                         | no       |                                        |
...
| `dockerfile`                  | :warning: **DEPRECATED**: _This input is deprecated and has been superseded; please use `project-file` instead. `dockerfile` will be removed in the future._ :warning:<br><br>Path to a Dockerfile, e.g. `src/Dockerfile`.                                                                                                                                     | no       |                                        |
