...
| `sign-image`                | If `true`, the action will sign the Docker image with Cosign. Signing requires the image to exist in the registry, so this is skipped when `push` is `false`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | no       | `true`                                                                                                             |
...
- name: Build
  ...
  with:
    ...
    sign-image:
    # If `true`, the action will sign the Docker image with Cosign. Signing requires the image to exist in the registry, so this is skipped when `push` is `false`.
    #
    # Required: no
    # Default: 'true'
